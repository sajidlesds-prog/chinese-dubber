...
class Google(BaseTrans):
    ...
    def _item_task(self, data: Union[List[str], str]) -> str:
        ...
        chunks = chunk_text(text, max_size=4500)
        ...
        for chunk in chunks:
            ...
            url = f"https://translate.google.com/m?sl={source_code}&tl={self.target_code}&hl={self.target_code}&q={chunk}"
            ...
            if not re_result or len(re_result.groups()) < 1:
                ...
                translated = re_result.group(1)
                results.append(translated if translated else chunk)
